//i just copy pasted this code from some npm package so i can use the arrive function lol
...
document.arrive('form', function(el) {
    ...
    timeAreaC = timeArea.children[0]
    timeAreaC.style.display = 'none'
    var timeEl = document.createElement('h1')
    
    timeArea.appendChild(timeEl)
    timeEl.id = 'time'
    timeArea.disabled = 'disabled'
    setTime()
})
